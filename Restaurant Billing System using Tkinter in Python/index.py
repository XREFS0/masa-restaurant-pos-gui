...
def system():
    ...
    root.title("MASA RestroBill Terminal")
    ...
    main_lbl = Label(
        topframe, font=("Arial", 25, "bold"), text="Restaurant Billing System", fg="Blue", anchor=W
    )
    ...
    ordlbl = Label(leftframe, font=("Arial", 16, "bold"), text="Order No.", fg="black", bd=5, anchor=W).grid(
        row=1, column=0
    )
    ordtxt = Entry(
        leftframe, font=("Arial", 16, "bold"), bd=6, insertwidth=4, justify="right", textvariable=orderno
    ).grid(row=1, column=1)
    pizlbl = Label(leftframe, font=("Arial", 16, "bold"), text="Pizza", fg="black", bd=5, anchor=W).grid(
        row=2, column=0
    )
    piztxt = Entry(
        leftframe, font=("Arial", 16, "bold"), bd=6, insertwidth=4, justify="right", textvariable=pizza
    ).grid(row=2, column=1)
    burlbl = Label(leftframe, font=("Arial", 16, "bold"), text="Burger", fg="black", bd=5, anchor=W).grid(
        row=3, column=0
    )
    burtxt = Entry(
        leftframe, font=("Arial", 16, "bold"), bd=6, insertwidth=4, justify="right", textvariable=burger
    ).grid(row=3, column=1)

    icelbl = Label(leftframe, font=("Arial", 16, "bold"), text="Ice Cream", fg="black", bd=5, anchor=W).grid(
        row=4, column=0
    )
    icetxt = Entry(
        leftframe, font=("Arial", 16, "bold"), bd=6, insertwidth=4, justify="right", textvariable=icecream
    ).grid(row=4, column=1)
    drinklbl = Label(leftframe, font=("Arial", 16, "bold"), text="Drinks", fg="black", bd=5, anchor=W).grid(
        row=5, column=0
    )
    drinktxt = Entry(
        leftframe, font=("Arial", 16, "bold"), bd=6, insertwidth=4, justify="right", textvariable=drinks
    ).grid(row=5, column=1)
    costlbl = Label(leftframe, font=("Arial", 16, "bold"), text="Cost", bd=5, anchor=W).grid(row=6, column=0)
    costtxt = Entry(
        leftframe, font=("Arial", 16, "bold"), bd=6, insertwidth=4, justify="right", textvariable=cost
    ).grid(row=6, column=1)
    sublbl = Label(leftframe, font=("Arial", 16, "bold"), text="Subtotal", bd=5, anchor=W).grid(
        row=7, column=0
    )
    subtxt = Entry(
        leftframe, font=("Arial", 16, "bold"), bd=6, insertwidth=4, justify="right", textvariable=subtotal
    ).grid(row=7, column=1)
    taxlbl = Label(leftframe, font=("Arial", 16, "bold"), text="Tax", bd=5, anchor=W).grid(row=8, column=0)
    taxtxt = Entry(
        leftframe, font=("Arial", 16, "bold"), bd=6, insertwidth=4, justify="right", textvariable=tax
    ).grid(row=8, column=1)
    servicelbl = Label(leftframe, font=("Arial", 16, "bold"), text="Service", bd=5, anchor=W).grid(
        row=9, column=0
    )
    servicetxt = Entry(
        leftframe, font=("Arial", 16, "bold"), bd=6, insertwidth=4, justify="right", textvariable=service
    ).grid(row=9, column=1)
    totallbl = Label(leftframe, font=("Arial", 16, "bold"), text="Total", bd=5, anchor=W).grid(
        row=10, column=0
    )
    totaltxt = Entry(
        leftframe, font=("Arial", 16, "bold"), bd=6, insertwidth=4, justify="right", textvariable=total
    ...
    def feedbackk():
        ...
        feed.title("MASA RestroBill Terminal")
        ...
        namelbl = Label(feed, font=("vardana", 15), text="Name:-", fg="black", bd=10, anchor=W).place(
            x=10, y=150
        )
        nametxt = Entry(
            feed, font=("vardana", 15), bd=6, insertwidth=2, bg="white", justify="right", textvariable=name
        ).place(x=15, y=185)
        ...
        emailtxt = Entry(
            feed, font=("vardana", 15), bd=6, insertwidth=2, bg="white", justify="right", textvariable=email
        ).place(x=285, y=185)

        ratelbl = Label(
            feed, font=("vardana", 15), text="How would you rate us?", fg="black", bd=10, anchor=W
        ).place(x=10, y=215)
        checkvar1 = StringVar()
        checkvar2 = StringVar()
        checkvar3 = StringVar()
        ...
        commentslbl = Label(feed, font=("Arial", 15), text="Comments", fg="black", bd=10, anchor=W).place(
            x=10, y=300
        )
        ...
        submit = Button(
            feed, font=("Arial", 14), text="Submit", fg="black", bg="green", bd=2, command=submit
        ).place(x=145, y=430)
        cancel = Button(
            feed, font=("Arial", 14), text="Cancel", fg="black", bg="red", bd=2, command=cancel
        ).place(x=245, y=430)
        feed.mainloop()
    ...
    def menu():
        roott = Tk()
        roott.title("MASA RestroBill Terminal")
